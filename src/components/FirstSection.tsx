...
const FirstSection = () => {
    return (
        <div className="md:px-8">{/*Primer section, contiene el titulo y un botón call to action*/}
            <section className="flex justify-center mb-12">
                <div className="mt-4 md:pl-7">
                    <div className="mx-auto w-2/3">
                        <h1 className="text-4xl ml-auto md:text-5xl md:font-semibold md:mt-20 md:mb-3 md:leading-tight ">Want anything to be easy with
            ...
            <section className="flex flex-col items-center w-3/5 space-y-6 mx-auto px-1 py-5 rounded-md shadow-2xl bg-slate-50 text-lg md:w-3/4 md:flex md:justify-evenly">
                {/* Primer Elemento */}
                <div className="flex flex-col text-center items-center md:space-x-2 ">
                ...
                {/*Segundo Elemento */}
                <div className="flex flex-col text-center items-center border-t-2 w-4/5 pt-5 md:space-x-2 md:border-l-2 md:pl-20 md:py-10">
                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-red-700 w-14 h-14 bg-red-100 p-4 rounded-full" viewBox="0 0 24 24">
                ...
                {/*Tercer Elemento */}
                <div className="flex flex-col text-center items-center border-t-2 w-4/5 pt-5 md:space-x-2 md:border-l-2 md:pl-20">
