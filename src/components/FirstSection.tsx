...
const FirstSection = () => {
    return (
        <div className="md:px-8 md:mt-5">{/*Primer section, contiene el titulo y un botón call to action*/}
            <section className="flex justify-center mb-12">
                <div className="mt-4 md:pl-7">
                    <div className="mx-auto w-2/3">
                        <h1 className="text-4xl ml-auto text-center md:text-5xl lg:font-semibold lg:mt-20 lg:mb-3 lg:leading-tight ">Want anything to be easy with
            ...
            <section className="flex flex-col items-center w-3/5 space-y-6 mx-auto px-1 py-5 rounded-md shadow-2xl bg-slate-50 text-lg lg:w-3/4 lg:flex lg:flex-row lg:justify-evenly lg:it">
                {/* Primer Elemento */}
                <div className="flex flex-col text-center items-center lg:space-x-2 lg:flex-row lg:pr-20">
                ...
                {/*Segundo Elemento */}
                <div className="flex flex-col text-center items-center border-t-2 lg:border-t-0 w-4/5 pt-5 lg:space-x-2 lg:border-l-2 lg:pl-20 lg:flex-row">
                    <svg xmlns="http://www.w3.org/2000/svg" className="fill-red-700 w-14 h-14 bg-red-100 p-4 rounded-full" viewBox="0 0 24 24">
