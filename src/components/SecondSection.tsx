...
const SecondSection = () => {
  return (
    <section className="flex h-screen justify-around">
      <div>
        <img src="src\assets\img\img-dos.png" alt="img-dos" className="ml-28" />
      </div>
      <div className="">
        <h3 className="w-3/5 text-4xl font-semibold leading-snug mb-2">We provide many features you can use</h3>
        <p className="w-3/4 mb-2">you can explore the features that we provide with fun and have their own functions each feature.</p>
        <ul>
          <li className="mt-5">
